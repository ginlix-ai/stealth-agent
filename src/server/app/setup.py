...
# Add CORS middleware
# Allowed origins loaded from conf.yaml
...
from src.server.app.conversation import users_router, conversations_router, messages_router
...
app.include_router(users_router)  # /api/v1/users/* - User endpoints
app.include_router(conversations_router)  # /api/v1/conversations/* - Conversation management
app.include_router(messages_router)  # /api/v1/messages/* - Message endpoints
app.include_router(cache_router)  # /api/v1/cache/* - Cache management
app.include_router(health_router)  # /health - Health check
app.include_router(workspaces_router)  # /api/v1/workspaces/* - Workspace management
